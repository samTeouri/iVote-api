...
const uploadFile = (0, multer_1.default)({
    ...
    fileFilter(req, file, callback) {
        const extension = ['.png', '.jpg', '.jpeg', '.pdf'].indexOf(path.extname(file.originalname).toLowerCase()) >= 0;
        const mimeType = ['image/png', 'image/jpeg', 'application/pdf'].indexOf(file.mimetype) >= 0;
